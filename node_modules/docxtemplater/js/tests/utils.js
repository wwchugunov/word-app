...
function cleanRecursive(arr) {
  ...
  for (var _i6 = 0; _i6 < arr.length; _i6++) {
    ...
    if (p.expanded instanceof Array) {
      for (var _i10 = 0, _p$expanded2 = p.expanded; _i10 < _p$expanded2.length; _i10++) {
        var _part = _p$expanded2[_i10];
...
function cleanError(e, expectedError) {
  ...
  if (expectedError.properties && e.properties) {
    ...
    if (e.properties.postparsed) {
      for (var _i12 = 0, _e$properties$postpar2 = e.properties.postparsed; _i12 < _e$properties$postpar2.length; _i12++) {
        var p = _e$properties$postpar2[_i12];
        delete p.lIndex;
        delete p.endLindex;
        delete p.offset;
      }
...
function start() {
  ...
  var _loop = function _loop() {
    var fullFileName = _fileNames2[_i14];
  ...
  for (var _i14 = 0, _fileNames2 = fileNames; _i14 < _fileNames2.length; _i14++) {
    if (_loop()) continue;
  }
  allStarted = true;
  endLoadFile(-1);
...
function createDocV3(name) {
  ...
  if (options.modules) {
    for (var _i16 = 0, _options$modules2 = options.modules; _i16 < _options$modules2.length; _i16++) {
      var _module = _options$modules2[_i16];
