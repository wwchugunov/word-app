  ...
  it("should not mutate options (regression for issue #526)", function () {
    var module = {
      ...
      optionsTransformer: function optionsTransformer(options, docxtemplater) {
        var _options$xmlFileNames;
        var relsFiles = docxtemplater.zip.file(/document.xml.rels/).map(function (file) {
          return file.name;
        });
        (_options$xmlFileNames = options.xmlFileNames).push.apply(_options$xmlFileNames, _toConsumableArray(relsFiles));
        return options;
      }
    };
    var opts = {
  ...
  it("should be possible to parse xml files : xmlFileNames.push() without side effect fixed since v3.55.0", function () {
    ...
    var module = {
      ...
      optionsTransformer: function optionsTransformer(options, docxtemplater) {
        ...
        // Fixed since 3.55.0
        (_options$xmlFileNames2 = options.xmlFileNames).push.apply(_options$xmlFileNames2, _toConsumableArray(relsFiles));
        return options;
      },
